...
package PkgKAN is
  -- Model parameters
  constant N_INPUT  : positive := 784;
  constant N_OUTPUT : positive := 10;

  -- bitwidths
  constant INPUT_WIDTH : positive := 1;
  ...
  constant SUM_WIDTH_0_9: positive := 11;
  ...
  constant SUM_WIDTH_0_15: positive := 11;
  ...
  constant SUM_WIDTH_0_34: positive := 11;
  ...
  constant SUM_WIDTH_0_36: positive := 9;
  ...
  constant SUM_WIDTH_0_44: positive := 11;
  ...
  constant SUM_WIDTH_0_46: positive := 6;
  subtype sum_t_0_46 is signed(SUM_WIDTH_0_46-1 downto 0);
  constant SUM_WIDTH_0_47: positive := 8;
