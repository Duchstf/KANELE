...
# Build the KAN LUT
kan_lut = KAN_LUT(model_dir, checkpoint, config, Moons_input_layer, device)
kan_lut.quick_match_check() #Test matching of LUT implementation with the base model KAN

#Generate the firmware
kan_lut.generate_firmware(clock_period=0.5, n_add=4, fpga_part="xczu7ev-ffvc1156-2-e")

#Simulate the firmware
kan_lut.simulate_firmware(latency=5)
